...
<head>
  ...
  <link rel="stylesheet" href="Delete Books.css">
</head>
<body>
...
<div class="wrapper">
 ...
 <nav id="sidebar" >
    ...
    <ul class="lisst-unstyled components" style="margin-top:50px;">
      <li >
      <a href="Profile.php">Librarian Profile</a>
    </li>
...
<div class="forms">
    <form class="loginbox" action="Delete_Book.php" method="post"  >
      <h1>Delete Books</h1>
      ...
      <div class="textbox" >
        ...
        <input type="text" name="Title_delete" value=""  class="col-lg-6">
        
      </div>
      <div class="textbox">
        <span class="col-lg-6">ISBN Number:</span>
        <input type="text"  name="ISBN_Number_delete" value="" class="col-lg-6" style="height:70px;">
      </div>


     <button type="submit" name="Delete" style="transform:translate(350px,-10px);" class="btn btn-primary">Delete</button>
